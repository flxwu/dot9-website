      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2">
              Trusted by over top-tier startups and companies all over the world
            </h2>
          </div>
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                  ...
                  <img
                    ...
                    src={require("../images/jack_moxon.jpg").default}
                    width="96"
                    height="96"
                ...
                <ReadMoreQuote
                  text={TESTIMONIAL_BLUECANVAS}
                  secondaryText={TESTIMONIAL_BLUECANVAS_SECONDARY}
                  min={150}
                  ideal={200}
                  max={200}
